...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <br/><br/>
            <hr/>
            <h3>Setting Todo as completed</h3>
            <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">
                Update Todo</a>
            <input defaultValue={todo.id} className="form-control w-25 float-start me-2"
                   onChange={(e) => setTodo({...todo, id: e.target.value})}/>
            <input type="button" defaultValue={"Completed"}
                   className="btn btn-primary form-control w-auto mx-1 float-start"
                   onClick={(e) => setTodo({...todo, completed: true})}/>
            <input type="button" defaultValue={"Incomplete"}
                   className="btn btn-primary form-control w-auto mx-1 float-start"
                   onClick={(e) => setTodo({...todo, completed: false})}/>
            <br/><br/>
            <hr/>
